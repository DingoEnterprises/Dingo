...
public class MainTaskActivity extends Activity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    public void viewTask(final MyTask task, final Context context) {
        ...
        viewImageAssignee.setImageResource(R.mipmap.ic_assignment_black_24dp); ///change this later
        ...
        b.getWindow().setLayout(1080, 1500);
        b.show();
    ...
    private void updateTask(final MyTask task, Context context) { //need a class called User  , User user
        ...
        imageAssignee.setImageResource(R.mipmap.ic_assignment_black_24dp); ///change this later
        String[] taskStatus = new String[4];
        taskStatus[0] = "Not Started";
        taskStatus[1] = "In Progress";
        taskStatus[2] = "Complete";
        taskStatus[3] = "Late";
        spinnerStatus.setSelection(task.getTaskstatussel());
